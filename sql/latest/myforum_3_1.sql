...
CREATE TABLE IF NOT EXISTS `imagegallery_albums` (
...
INSERT INTO `imagegallery_albums` (`id`, `user_id`, `name`, `description`, `place`, `date`, `status`) VALUES
...
CREATE TABLE IF NOT EXISTS `imagegallery_photos` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `imagegallery_photos` (`id`, `user_id`, `album_id`, `title`, `description`, `place`, `actual_name`, `actual_file_name`, `photo_save_path`, `date`, `status`) VALUES
...
CREATE TABLE IF NOT EXISTS `imagegallery_photo_comments` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `like` (`id`, `users_id`, `wpwpr_id`, `photos_id`, `module_table_id`, `module_table_name`) VALUES
...
INSERT INTO `poll` (`id`, `question`, `user_id`, `module_table_id`, `module_table_name`, `date`, `status`) VALUES
...
INSERT INTO `poll_options` (`id`, `poll_id`, `option_key`, `option_text`, `date`, `status`) VALUES
(1, 1, 1, 'Ugly', NULL, 1),
(2, 1, 2, 'Bad', NULL, 1),
(3, 1, 3, 'Ok', NULL, 1),
(4, 1, 4, 'Good', NULL, 1),
...
INSERT INTO `poll_votes` (`id`, `poll_options_id`, `poll_options_other_text`, `vote`, `user_id`, `date`, `status`) VALUES
(1, 1, NULL, 1, 9, NULL, 1),
(2, 2, NULL, 1, 8, NULL, 1),
(3, 3, NULL, 1, 7, NULL, 1),
(4, 4, NULL, 1, 6, NULL, 1),
...
INSERT INTO `qna_post` (`id`, `title`, `content`, `slug`, `parent_id`, `date`, `user_id`, `user_ip`, `status`) VALUES
...
CREATE TABLE IF NOT EXISTS `qna_vote` (
  `id` int(11) NOT NULL AUTO_INCREMENT,

...
function fheader($title='', $css='', $js='')
{
	...
	$bootstrap_css = $globals['boardurl']."/$themedir/".$user['theme_type'] . '/bootstrap/css/bootstrap.min.css';
	$bootstrap_css_str = '<link rel="stylesheet" type="text/css" href="'.$bootstrap_css.'">';
	...
	<!DOCTYPE html>
		...
		<head>
			...
			<link rel="shortcut icon" href="images/error-ico.png">
...
function ffooter($time_elapsed=0)
{
	...
	$foot = '
		...
		// Loading bootstrap first
		$js_file = $globals['boardurl']."/$themedir/". $user['theme_type'] . '/bootstrap/js/bootstrap.min.js';
